// BackEnd/tests/fileRouter.test.js
...
jest.mock('../Controllers/fileControllers', () => ({
...
describe('File Router', () => {
  ...
  it('should list files on GET /files/files', async () => {
    const response = await request(app).get('/files/files');
    expect(response.status).toBe(200);
